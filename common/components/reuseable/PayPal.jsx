...
import { actions as cartActions } from "@/common/store/cart-slice";
...
const PayPal = ({ totalAmount, tax, grandTotal }) => {
    ...
    }, [dispatch, order, totalAmount, grandTotal, tax, error, paymentApproved, router, token]);

    return (
        <div style={{ position: "relative", zIndex: "0" }}>
            {!error && !paymentApproved && <div ref={paypalRef}></div>}
            {!error && paymentApproved && <h4>Your payment has been approved.</h4>}
            {error && (
                <div>
