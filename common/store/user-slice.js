...
// user login
export const userLogin = createAsyncThunk("users/login", async (payload, { rejectWithValue, getState }) => {
    try {
...
// user logout
export const userLogout = createAsyncThunk("users/logout", async (payload, { rejectWithValue, getState }) => {
    try {
        const response = await axios({
            url: "/accounts/logout/",
            method: "POST",
...
// user registration
export const userRegister = createAsyncThunk("users/register", async (payload, { rejectWithValue, getState }) => {
    try {
        const response = await axios({
