...
// cart list
export const getCartList = createAsyncThunk("cart/list", async (payload, { getState, rejectWithValue }) => {
    const token = payload;
    try {
...
const { actions, reducer } = createSlice({
    ...
    reducers: {
        ...
        getGuestCartList(state, action) {
            state.cartList = JSON.parse(localStorage.getItem("safekart_cartItem")) || [];
        },
    },
