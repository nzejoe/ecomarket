...
// style
import styles from "@/common/modules/CheckoutPage.module.css";
...
const CheckoutPage = () => {
    ...
    }, [firstName, middleName, lastName, gender, email, phone, address_1, address_2, city, state, country]);
                        ...
                        <form onSubmit={handleSubmit}>
                            {formHasError && (
                                <div className="messages">
                                    <p className="text-error text-center capitalize">please fill form properly!</p>
                                </div>
                            )}
                            ...
                            <div className={`${styles.row} ${styles.col__2}`}>
                                ...
                                <div className={styles.form__group}>
                                    <select name="gender" onChange={(e) => setGender(e.target.value)} id="gender">
